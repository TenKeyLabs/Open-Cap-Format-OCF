...
const FILE_FIXTURE: FileSchemaNodeJson = {
  ...
  allOf: [
    {
      $ref: "https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/primitives/files/File.schema.json",
    },
  ],
  properties: {
    ...
    items: {
      ...
      items: {
        $ref: "https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/objects/Valuation",
      },
    },
  },
...
const ENUM_FILE_TYPE_SCHEMA_NODE_FIXTURE: EnumSchemaNodeJson = {
  $id: "https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/enums/FileType.schema.json",
...
const BASE_FILE_SCHEMA_NODE_FIXTURE: PrimitiveSchemaNodeJson = {
  $id: "https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/primitives/files/File.schema.json",
  title: "Object - File",
...
\`https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/files/TestFile.schema.json\`
