...
const FIXTURE: PrimitiveSchemaNodeJson = {
  $id: "https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/primitives/TestPrimitive.schema.json",
  ...
  properties: {
    ...
    refProperty1: {
      $ref: "https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/primitives/TestPrimitive.schema.json",
    },
  },
  required: ["1"],
};
...
\`https://raw.githubusercontent.com/TenKeyLabs/Open-Cap-Format-OCF/main/schema/primitives/TestPrimitive.schema.json\`
